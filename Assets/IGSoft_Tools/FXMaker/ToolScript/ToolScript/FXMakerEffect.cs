...
//	protected		string[]			m_EffectNameStrings;	// = new string[gNcLayout.m_nMaxEffectListCount];
	...
	protected		int[]				m_nCameraAangleValues	= { 90, 40, 0, 20 };	// { "Top", "HighQ", "Back", "LowQ" };
	...
	protected		int					m_nCameraAngleIndex		= 1;
	...
	void Awake()
	{
		...
		{
			m_nCameraAngleIndex				= EditorPrefs.GetInt("FXMakerEffect.m_nCameraAngleIndex", m_nCameraAngleIndex);
		}
...
//			m_nCameraAngleIndex	= GUI.SelectionGrid(gridRect, m_nCameraAngleIndex, FXMakerTooltip.GetHcToolEffect_Camera(), 2);
			m_nCameraAngleIndex	= FXMakerLayout.TooltipSelectionGrid(FXMakerLayout.GetMenuTopRightRect(), gridRect, m_nCameraAngleIndex, FXMakerTooltip.GetHcToolEffect_Camera(), 2);
