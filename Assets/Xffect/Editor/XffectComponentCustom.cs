...
public class XffectComponentCustom : Editor
{
	...
	public string curVersion = "3.1.0";
	...
	void DrawInfos()
	{
		...
		string curversion = "Version:" + curVersion; 
		
        
        XEditor.DrawInfo(curversion);
        XEditor.DrawInfo("Arthor: shallway");
        XEditor.DrawInfo("Contact: shallwaycn@gmail.com, skype ID: shallwaycn");
